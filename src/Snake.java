...
public class Snake {
    ...
    public void init() {
        ...
        //Crear barra de menu con sus funciones
        setJMenueBar(frame);
        //Iniciar el UI
        JPanel scorePanel = new JPanel();
        scoreViewer = new JTextArea("Puntuacion ==>" + score);
    ...
    public void setJMenueBar(JFrame frame) {
        ...
        JMenu type = new JMenu("Tipo");
        JMenuItem noMaze = new JMenuItem("Sin bordes");
        ...
        JMenuItem border = new JMenuItem("Con bordes");
        ...
        JMenu level = new JMenu("Niveles");
        JMenuItem level1 = new JMenuItem("Nivel 1");
        ...
        JMenuItem level2 = new JMenuItem("Nivel 2");
        ...
        JMenuItem level3 = new JMenuItem("Nivel 3");
        ...
        JMenuItem instruction = new JMenuItem("Instrucciones");
        creator.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {     
              ImageIcon icon = new ImageIcon(Snake.class.getResource("/logopequeno.png"));
